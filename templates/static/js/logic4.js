...
function createPlots(newSearchRequest) {
    ...
    // Read in json data 
    d3.csv("https://raw.githubusercontent.com/EdwinVargas22/Project-2-Group-4/main/output.cases_deaths_df.csv").then((data) => {
        ...
        var caliCounty = data.county;
        var caliCases = data.cases;
        var caliDeaths = data.deaths;
        // var caliDeaths = data.deaths;
        ...
        // var namesList = [];
        // var currentcaliCounty = [];
        // var currentcaliState = [];
        // var currentcaliCases = [];
        // var currentcaliDeaths = [];
        // var currentWFreq = [];
        ...
        //     for (var i = 0; i < currentcaliCounty.length; i ++) {
        //         if (currentcaliCounty[i] === newSearchRequest) {
        ...
        var bubbleLayout = {
            title: `California COVID`,
            xaxis: {title: "COVID Cases"},
            yaxis: {title: "COVID Deaths"},
            height: 600,
            width: 1200,
            paper_bgcolor: 'rgb (248,248,255)',
            plot_bgcolor: 'rgb(248,248,255)'
